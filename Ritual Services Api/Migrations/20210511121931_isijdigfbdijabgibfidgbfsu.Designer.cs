...
namespace Ritual_Services_Api.Migrations
{
    ...
    [Migration("20210511121931_isijdigfbdijabgibfidgbfsu")]
    partial class isijdigfbdijabgibfidgbfsu
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ritual_Services_Api.Models.Entities.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ritual_Services_Api.Models.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ritual_Services_Api.Models.Entities.PlaceCemetary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Ritual_Services_Api.Models.Entities.Identity.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Ritual_Services_Api.Models.Entities.Identity.UserAdditionalInfo", b =>
                {
                    b.HasOne("Ritual_Services_Api.Models.Entities.Identity.User", "User")
                        ...
                        .HasForeignKey("Ritual_Services_Api.Models.Entities.Identity.UserAdditionalInfo", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Ritual_Services_Api.Models.Entities.Ware", b =>
                {
                    b.HasOne("Ritual_Services_Api.Models.Entities.Category", "Category")
                        .WithMany("Wares")
